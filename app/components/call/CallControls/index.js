...
export default class CallControls extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (call.getState() != 'PJSIP_INV_STATE_INCOMING') {
      Animated.parallel([
        Animated.timing(this.state.hangupOffset, {
          toValue: this.state.answerOffset,
        }),
      ]).start();
  ...
  render() {
    ...
    return (
      <View style={[s.container, {width: this.state.screenWidth}]}>
        <Animated.View
          style={[{left: this.state.hangupOffset}, s.buttonContainer]}>
          <TouchableOpacity
            onPress={this._onHangupPress}
            style={[
              s.buttonTouchable,
              call.getState() == 'PJSIP_INV_STATE_DISCONNECTED'
                ? s.buttonDisabled
                : s.buttonRed,
            ]}>
            <Image
              source={require('../../../assets/images/call/action-hangup.png')}
            />
          </TouchableOpacity>
        </Animated.View>
        ...
        {this.state.answerable && (
          <Animated.View
            ...
            <TouchableOpacity
              ...
              style={[s.buttonTouchable, s.buttonGreen]}>
              <Image
                source={require('../../../assets/images/call/action-answer.png')}
              />
            </TouchableOpacity>
          </Animated.View>
        )}
        ...
        {this.state.answerable && (
          <Animated.View
            style={[
              {
                left: this.state.transferOffset,
                opacity: this.state.transferOpacity,
              },
              s.buttonContainer,
            ]}>
            <TouchableOpacity
              onPress={this._onRedirectPress}
              style={[s.buttonTouchable, s.buttonYellow]}>
              <Image
                source={require('../../../assets/images/call/action-redirect.png')}
              />
            </TouchableOpacity>
          </Animated.View>
        )}
