...
export default class CallParallelInfo extends Component {
  ...
  onTick() {
    if (
      ...
      this.statusTextInput.setNativeProps({
        text: this.props.call.getFormattedConnectDuration(),
      });
    }
  }
  ...
  render() {
    ...
    const icon = call.isHeld()
      ? require('../../../assets/images/call/icon-paused.png')
      : require('../../../assets/images/call/icon-active.png');
