...
export function calculateDimensionsForIncomingCall({
  screenHeight,
  infoHeight,
  stateHeight,
  actionsHeight,
...
export function calculateDimensionsForActiveCall({
  screenHeight,
  infoHeight,
  stateHeight,
  actionsHeight,
  ...
  const switchHeight = calculateCallSwitchHeight(totalCalls);
  const totals =
    switchHeight + infoHeight + stateHeight + actionsHeight + buttonsHeight;
  const spaces = screenHeight - totals;
  const space = spaces / 5;
...
export function calculateDimensionsForTerminatedCall({
  screenHeight,
  infoHeight,
  stateHeight,
  buttonsHeight,
